        ...
        <>
            <div className="event-planner-container">
                ...
                <section className="testimonials">
                    ...
                    <div className="testimonial">
                        <p>"The baby shower was so beautifully set up, and the whole vibe was super warm and fun. Everything felt so special, making it a day to remember!"</p>
                        <p className="author">- Amy Anderson</p>
                    </div>
                </section>
